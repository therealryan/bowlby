                    ...
                    .call(c -> c.to(Actors.GITHUB)
                        ...
                        .request(ApiMessage.request(
                                "/repos/therealryan/bowlby/actions/runs/" + ArtifactRun.RUN_ID
                                    + "/artifacts")
                            .set(ArtifactRun.RUN_ID, 11111)
                            .masking(Unpredictables.RNG, m-> m
                                .replace(ArtifactRun.RUN_ID, "_masked_"))
                        )
                        .response(ApiMessage.response(
            ...
            .call(a -> a
                ...
                .call(b -> b.to(Actors.BOWLBY)
                    ...
                    .response(HttpMessage.redirectResponse(
                            "/artifacts/therealryan/bowlby/" + ArtifactRun.ALPHA_ID + "/")
                        .set(ArtifactRun.ALPHA_ID, 22222)
                    ...
                    .call(c -> c.to(Actors.GITHUB)
                        .request(ApiMessage.request(
                                "/repos/therealryan/bowlby/actions/artifacts/"
                                    + ArtifactRun.ALPHA_ID + "/zip")
                            .set(ArtifactRun.ALPHA_ID, 22222)
                            .masking(Unpredictables.RNG, m -> m
                                .replace(ArtifactRun.ALPHA_ID, "_masked_")) )
