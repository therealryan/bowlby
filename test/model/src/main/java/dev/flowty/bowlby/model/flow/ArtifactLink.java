  ...
  public ArtifactLink( Index index ) {
    ...
    Flow submit = Creator.build( flow -> flow
        ...
        .call( a -> a
            ...
            .request( WebMessage.submit(
                "https://github.com/therealryan/bowlby/actions/runs/" + 11111
                    + "/artifacts/" + 33333 ) )
            .call( b -> b.to( Actors.BOWLBY )
                ...
                .request( HttpMessage.chromeRequest( "GET", ""
                    ...
                    + 11111 + "%2Fartifacts%2F" + 33333 ) )
                .response( HttpMessage.redirectResponse(
                    "/artifacts/therealryan/bowlby/" + 33333 + "/" ) ) )
            .call( b -> b.to( Actors.BOWLBY )
                .tags( Tags.add( "download" ) )
                .request( HttpMessage.chromeRequest( "GET",
                    "/artifacts/therealryan/bowlby/" + PathVars.BETA_ID + "/" )
                    .set( PathVars.BETA_ID, 33333 ) )
                .call( c -> c.to( Actors.GITHUB )
                    .request( ApiMessage.request(
                        "/repos/therealryan/bowlby/actions/artifacts/"
                            + PathVars.BETA_ID + "/zip" )
                        .set( PathVars.BETA_ID, 33333 )
                        .masking( Unpredictables.RNG, m -> m
                            .replace( PathVars.BETA_ID, "_masked_" ) ) )
            ...
            .response( WebMessage.summarise()
                ...
                .set( "lists", ""
                    ...
                    + "/subdir/)" )
                .set( "url",
                    "http://[::]:56567/artifacts/therealryan/bowlby/" + (long) 33333
                        + "/" ) ) ),
        chain );
    ...
    Flow dir = Creator.build( flow -> flow.meta( data -> data
        ...
        .call( a -> a
            ...
            .call( b -> b.to( Actors.BOWLBY )
                .request( HttpMessage.chromeRequest( "GET",
                    "/artifacts/therealryan/bowlby/" + PathVars.BETA_ID + "/subdir/" )
                    .set( PathVars.BETA_ID, 33333 ) )
            ...
            .response( WebMessage.summarise()
                ...
                .set( "lists", ""
                    ...
                    + "/subdir/subfile.txt)" )
                .set( "url",
                    "http://[::]:56567/artifacts/therealryan/bowlby/" + 33333
                        + "/subdir/" ) ) ),
        chain );
